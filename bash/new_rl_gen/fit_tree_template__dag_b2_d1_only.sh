...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-rl-fit-tree-template__dag-b2-d1-only}"
export TRAIN_FILES="${TRAIN_FILES:-['data/string_task/new_rl_gen/dag_b2_d1_only/forward_train.parquet']}"
