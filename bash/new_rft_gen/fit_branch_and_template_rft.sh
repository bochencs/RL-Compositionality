...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-fit-branch-and-template}"
...
export TRAIN_FILES="${TRAIN_FILES:-data/string_task/new_rft_gen/model2/rft_data/train.parquet}"
export VAL_FILES="${VAL_FILES:-data/string_task/new_rft_gen/model2/rft_data/test.parquet}"
