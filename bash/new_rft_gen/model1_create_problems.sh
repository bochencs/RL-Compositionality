...
BASE_DIR="${BASE_DIR:-data/string_task/new_rft_gen/model1}"
...
generate_explicit_stage1_dataset "${PROBLEM_DIR}/branch1_depth1_train.parquet" train 1 1 "${NEW_TRAIN}"
generate_explicit_stage1_dataset "${PROBLEM_DIR}/branch1_depth1_test.parquet" test 1 1 "${NEW_TEST}"
...
echo "[model1_create_problems] done"
echo "- atomic train/test: ${ATOMIC_TRAIN}/${ATOMIC_TEST}"
echo "- new train/test: ${NEW_TRAIN}/${NEW_TEST}"
